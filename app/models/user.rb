class User < ApplicationRecord
  ...
  puts("") 
  Question.find_or_create(
  title: 'se sente confortável ao assumir riscos em novas iniciativas?'
  option_1: 'Nunca',
  option_2: 'as vezes',
  ...
  # puts("Como você lida com conflitos entre membros da equipe?")
  ...
  # puts("Você prefere trabalhar em equipe ou de forma independente?")
